...
w_attn_pretrained, w_fc_pretrained, w_norm_pretrained = get_weights(model_pretrained, '1')
w_attn_finetuned, w_fc_finetuned, w_norm_finetuned = get_weights(model, '1')
